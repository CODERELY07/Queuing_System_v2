<footer class="bg-gray-800 text-white py-8">
  <div class="container mx-auto px-4">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      <!-- About -->
      <div>
        <h3 class="text-lg font-semibold mb-4">MedQueue System</h3>
        <p class="text-gray-400">Streamlining patient flow in healthcare facilities with digital queuing solutions.</p>
      </div>
